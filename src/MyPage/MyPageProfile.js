        ...
        return (
            <View style={[styles.profileContainer]}>
                <View style={{ width: '90%', flexDirection: 'row', flex: 3, alignItems: 'center', marginLeft: '5%' }}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-around', flex: 3 }}>
                        <View style={{ flexDirection: 'column', alignItems : 'center', marginLeft : '10%' }}>
                            <Text style={{ fontFamily: 'profile', fontSize : 12, marginBottom : 5 }}>
                                Writing
                            </Text>
                            <Text style={{fontFamily : 'content', fontSize : 20, fontWeight : 'bold'}}>
                                69
                            </Text>
                        </View>
                ...
                <View style={{ width : ' 90%', marginLeft : '5%', flexDirection: 'column', flex: 2 }}>
                    <Text style={{ fontFamily: 'topbar', marginLeft: 10, fontSize : 13 }}>
                        3년차서당개
                    </Text>
                    <Text style={{ fontFamily: 'profile', marginLeft: 10, marginTop: 5, fontSize : 12 }}>
                        풍월 딱 대 ㅋㅋ
                    </Text>
                </View>
